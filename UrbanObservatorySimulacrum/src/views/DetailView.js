                ...
                <div class="detail-header">
                    <div class="detail-header-top">
                        <div class="detail-title-wrapper">
                            ...
                            <div>
                                <h1 class="detail-title">${project.city}</h1>
                                <p class="detail-coords">Lat: ${project.latitude}/ Lon: ${project.longitude}</p>
                            </div>
                        </div>
                        <span class="badge ${project.state}" style="font-size: 1rem; padding: 0.5rem 1rem;">${project.state}</span>
                    </div>
                    <p class="detail-description">${project.name}</p>
                </div>
